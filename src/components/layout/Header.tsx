            ...
            <div className="w-full h-full flex items-center justify-between px-4 lg:px-8">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <nav className="hidden lg:flex items-center gap-1 ml-6">
                        <Link href="/" className="px-3 py-1.5 text-sm font-medium text-white bg-slate-800/50 rounded-md border border-slate-700/50">Market Board</Link>
                        <button className="px-3 py-1.5 text-sm font-medium text-slate-400 hover:text-slate-200 transition">News</button>
                        <button className="px-3 py-1.5 text-sm font-medium text-slate-400 hover:text-slate-200 transition">Screener</button>
                        <button className="px-3 py-1.5 text-sm font-medium text-slate-400 hover:text-slate-200 transition">Brokers</button>
                    </nav>
                </div>
